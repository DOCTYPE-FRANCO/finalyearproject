    ...
    return(
        <div>
            ...
            <div className="flex justify-center pt-6 gap-4">
                ...
                <button className="w-[170px] h-[45px] border border-blue-600 rounded-sm text-blue-600 hover:bg-blue-600 transition-all duration-1000 hover:text-white">LEARN MORE</button>
            </div>
        </div>
    );
}
